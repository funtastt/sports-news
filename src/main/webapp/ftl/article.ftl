                    ...
                    <div class="article-details">
                        <div class="author">
                            ...
                            <a href="/user?userId=${article.authorId}">
                                <img width="48" height="48" src="${article.authorProfilePicture}" alt="${article.author}"
                            ...
                            <div class="comment card"
                                ...
                                <a href="/user?userId=${comment.userId}">
                                    <div class="user-avatar" style="display: flex; align-items: center;">
                                        <img src="<#if comment.profilePictureUrl?has_content>${comment.profilePictureUrl}<#else>https://dummyimage.com/40x40/dee2e6/6c757d.jpg</#if>"
                                             alt="User Avatar" width="48" height="48" style="margin-right: 8px;" class="rounded-circle">
                                ...
                                <div class="comment-details">
                                    <div class="d-flex justify-content-between text-wrap">
                                        ...
                                        <p class="timestamp font-weight-light m-1"
